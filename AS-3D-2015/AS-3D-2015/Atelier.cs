...
namespace AtelierXNA
{
    ...
    public class Atelier : Microsoft.Xna.Framework.Game
    {
        ...
        public bool EstManetteUtilisé { get; set; }
        ...
        protected override void Initialize()
        {
            ...
            GrilleCollision MaGrille = new GrilleCollision(this, new Vector2(DIMENSION_TERRAIN, DIMENSION_TERRAIN), 5.22449f / 2f, "Labyrinthe", 0);
            ...
            Services.AddService(typeof(GrilleCollision), MaGrille);
